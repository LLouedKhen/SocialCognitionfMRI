...
logFile = os.path.join(subjPath, "CAToon_output" + subjNum + ".txt")
with open(logFile, "a") as f:
        ...
        # Set up initial variables for continuous key presses
          ...
          for key in keyState:
            ...
            if '4' in press:
              ...
              print('Subject selected ' + selResp + ' at ' + str(t3[len(t3) -1]), file=f)
    ...
    print('Experiment ended at ', endExp, file=f)
    print('Experiment took ', endExp - startExp, file=f)
    # rt = rt[0::4]
# correct = correct[0::4]
...
allResults.to_csv(os.path.join(subjPath, 'CAToon' + subjNum + '_Data.csv'))
subjData = pd.Series([subjNum, startExp, trigTime, endExp])
subjData.to_csv(os.path.join(subjPath, 'CAToon' + subjNum + '_subjData.csv'))
